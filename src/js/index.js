...
// OBJETIVO 1
// OB1: Passo 1 - Pegar os botões no JS pra poder verificar quando o usuário clicar em cima de um deles
const botoes = document.querySelectorAll(".botao");

// OBJETIVO 2
// OB2: Passo 1 - pegar os personagens no JS pra poder mostrar ou esconder ele
